...
namespace OxidEsales\ExamplesModule\Tests\Settings\Service;

use OxidEsales\EshopCommunity\Internal\Framework\Module\Facade\ModuleSettingService;
use OxidEsales\ExamplesModule\Core\Module;
use OxidEsales\ExamplesModule\Settings\Service\ModuleSettingsService;
...
final class ModuleSettingsTest extends TestCase
{
    ...
    public static function getGreetingModeDataProvider(): array
    {
        return [
            ...
            [
                ...
                'expected' => \OxidEsales\ExamplesModule\Settings\Service\ModuleSettingsService::GREETING_MODE_GENERIC
            ],
            [
    ...
    public static function isPersonalGreetingModeDataProvider(): array
    {
        return [
            [
                'value' => \OxidEsales\ExamplesModule\Settings\Service\ModuleSettingsService::GREETING_MODE_GENERIC,
                'expected' => false
            ],
            [
                'value' => ModuleSettingsService::GREETING_MODE_PERSONAL,
    ...
    public function testIsLoggingEnabledReturnsTrue(): void
    {
        ...
        $mssMock->method('getBoolean')->willReturnMap([
            [\OxidEsales\ExamplesModule\Settings\Service\ModuleSettingsService::LOGGER_STATUS, Module::MODULE_ID, true]
        ]);
